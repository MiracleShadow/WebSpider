...
class NewsSpider:
    name = "HFUT_exchange"
    csv_file_path = "CSVFiles/HFUT_exchange_news.csv"
    News_Page_Url = "http://news.hfut.edu.cn/list-162-1.html"
    headers = {
        'User-Agent':
    ...
    def work(self, page_num=None):
        ...
        for i in range(page_num, 0, -1):
            news_page_url = "http://news.hfut.edu.cn/list-162-{}.html".format(i)
